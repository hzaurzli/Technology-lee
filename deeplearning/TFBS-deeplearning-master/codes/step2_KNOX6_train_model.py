...
def LSTMs():
    ...
    x = Bidirectional(LSTM(50,return_sequences=True,activation='tanh'))(x)  ###TCN
...
class TCN_Net():
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        filepath = 'knox6TCN.h5'  ####原最佳模型7dimmodelATT_TCNnew.h5
...
class LSTM_Net():
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        LSTMmodel.summary()
        from keras.callbacks import ModelCheckpoint
        filepath = 'knox6LSTM.h5'  ####原最佳模型7dimmodelATT_TCNnew.h5
        checkpoint = ModelCheckpoint(filepath,
                                     monitor='val_accuracy',
                                     verbose=0,
                                     save_best_only=True,
